    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(default=b'COMPLETE', max_length=16, choices=[(b'COMPLETE', b'Complete'), (b'INCOMPLETE', b'Incomplete')])),
                ('preservation', models.CharField(default=b'PRESERVED', max_length=16, choices=[(b'PRESERVED', b'Preserved'), (b'LACKING', b'Lacking')])),
                ...
                ('book_id', models.ForeignKey(related_name=b'locate', to='gesualdo.Book', to_field=b'book_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_date', models.CharField(max_length=16, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mei_link', models.FileField(null=True, upload_to=b'partitions', blank=True)),
                ('mp3_link', models.URLField(null=True, blank=True)),
                ('notes', models.TextField(null=True, blank=True)),
                ('book_id', models.ForeignKey(related_name=b'include', to_field=b'book_id', blank=True, to='gesualdo.Book', null=True)),
